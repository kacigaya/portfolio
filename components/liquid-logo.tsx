...
export function LiquidLogo({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <canvas ref={canvasRef} className="pointer-events-none absolute inset-0 h-full w-full invisible brightness-10 dark:brightness-100 motion-safe:data-ready:visible" />
    </span>
  );
}
